...
public class OrderOutboxRepositoryImpl implements OrderOutboxRepository {
    ...
    public OrderOutboxMessage save(OrderOutboxMessage orderPaymentOutboxMessage) {
        var entity = orderOutboxDataAccessMapper.orderOutboxMessageToOutboxEntity(orderPaymentOutboxMessage);
        var savedEntity = orderOutboxJpaRepository.save(entity);
        return orderOutboxDataAccessMapper.orderOutboxEntityToOrderOutboxMessage(savedEntity);
    }
